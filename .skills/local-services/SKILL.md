...
2. **storyheal-api** — Core API gateway (port 8000)
3. **storyheal-ai** — LLM / Agent runtime (port 8081)
...
| storyheal-api | `make dev-api` | 8000 | Always |
| storyheal-ai | `make dev-ai` | 8081 | Always |
| storyheal-rag | `make dev-rag` | 18082 | Knowledge base / RAG changes |
| storyheal-platform | `make dev-platform` | 8003 | Channel integration changes |
| storyheal-workflow | `make dev-workflow` | 8004 | Workflow engine changes |
| storyheal-plugin-runtime | `make dev-plugin` | 8090 | Plugin / MCP tool changes |
| storyheal-device-control | `make dev-device` | 8085 | Device management changes |
| storyheal-web | `make dev-web` | 5173 | Admin frontend changes |
| storyheal-widget | `make dev-widget` | 5174 | Visitor widget changes |
