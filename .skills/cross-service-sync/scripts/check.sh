...
echo "  storyheal-api ↔ storyheal-ai: chat schemas, tool schemas"
echo "  storyheal-api ↔ storyheal-web: all API response types"
echo "  storyheal-api ↔ storyheal-widget: visitor/chat message types"
echo "  storyheal-ai ↔ storyheal-plugin-runtime: tool call/result schemas"
echo "  storyheal-device-control ↔ storyheal-device-agent: JSON-RPC protocol"
echo "  storyheal-widget ↔ storyheal-widget: json-render types"
