...
Core Business Logic Microservice for the StoryHeal customer service platform.
...
```env
# Database
DATABASE_URL=postgresql://postgres:password@localhost:5432/storyheal_api
...
# API Configuration
PROJECT_NAME=StoryHeal API Service
