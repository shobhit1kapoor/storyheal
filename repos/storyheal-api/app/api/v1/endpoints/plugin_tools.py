"""Plugin Tools proxy endpoints - Proxies to storyheal-plugin-runtime service."""
...
async def execute_plugin_tool(
    ...
    """
    Proxy an MCP tool execution request to storyheal-plugin-runtime.
    
    Called by storyheal-ai when an agent uses a plugin-provided tool.
    """
