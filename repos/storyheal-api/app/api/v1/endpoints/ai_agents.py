...
async def _enrich_agent_with_device(
    ...
    """Enrich a single agent dict with bound_device info from storyheal-device-control.
...
async def list_agents(
    ...
    # Enrich agents with bound device info from storyheal-device-control
...
async def get_agent(
    ...
    # Enrich with bound device info from storyheal-device-control
