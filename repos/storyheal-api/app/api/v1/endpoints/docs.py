...
- /docs/api - Current API service (storyheal-api)
- /docs/ai - AI service
- /docs/rag - RAG service
- /docs/platform - Platform service
"""
...
@router.get("/api", response_class=HTMLResponse, summary="StoryHeal API Documentation")
async def docs_api():
    """Swagger UI for the current StoryHeal API service."""
    return HTMLResponse(_swagger_ui_html("StoryHeal API Service", f"{settings.API_V1_STR}/openapi.json"))
