...
async def create_ai_provider(
    ...
    # Attempt to sync to storyheal-ai with retry (non-blocking for main flow)
    try:
...
async def update_ai_provider(
    ...
    # Attempt to sync to storyheal-ai (non-blocking)
    try:
        await sync_provider_with_retry_and_update(db, item)
    except Exception as e:
...
async def enable_ai_provider(
    ...
    # Sync status to storyheal-ai with retry (non-blocking)
    try:
        await sync_provider_with_retry_and_update(db, item)
    except Exception as e:
...
async def sync_ai_provider_now(
    ...
    """Manually trigger sync of a single AI provider to storyheal-ai."""
