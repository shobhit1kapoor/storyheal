...
from app.core.exceptions import (
    StoryHealAPIException,
    general_exception_handler,
    http_exception_handler,
    storyheal_api_exception_handler,
...
def create_app(
    ...
    application.add_exception_handler(StoryHealAPIException, storyheal_api_exception_handler)
    ...
    async def startup_event():
        ...
        startup_log("")
        startup_log("🎉 StoryHeal API Service is ready!")
        startup_log("═" * 64)
    ...
    async def root() -> dict[str, str]:
        """Root endpoint."""
        return {"message": "StoryHeal API Service", "version": settings.PROJECT_VERSION}
    ...
    def readiness_check() -> dict[str, str]:
        """Readiness requires the durable database, not merely a live process."""
