...
class RAGServiceClient:
    ...
    def _get_headers(self) -> Dict[str, str]:
        ...
        headers = {
            ...
            "X-Internal-Key": settings.RAG_INTERNAL_API_KEY,
        }
        return headers
    ...
    async def upsert_storyblok_source(
        ...
        *,
        ...
        """Idempotently embed a published Storyblok locale."""
        response = await self._make_request(
            "PUT",
            f"/v1/collections/{collection_id}/external-sources/storyblok/{story_uuid}",
            json_data={"project_id": project_id, **source},
        )
        return await self._handle_response(response)
