"""Device Control Service Client - HTTP client for storyheal-device-control service."""
...
class DeviceControlClient:
    """HTTP client for communicating with storyheal-device-control service."""
    ...
    async def run_agent_stream(
        ...
        Args:
            ...
            provider_id: AI Provider ID for LLM calls via storyheal-ai service.
