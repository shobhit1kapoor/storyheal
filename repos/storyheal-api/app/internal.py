...
internal_app.add_exception_handler(StoryHealAPIException, storyheal_api_exception_handler)
...
async def internal_root() -> dict[str, str]:
    ...
    return {
        "message": "StoryHeal Internal Services",
        "version": settings.PROJECT_VERSION,
...
async def internal_startup_event():
    ...
    startup_log("═" * 64)
    startup_log("🔧 StoryHeal Internal Services Starting...")
    startup_log("═" * 64)
