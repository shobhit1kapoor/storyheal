...
Usage:
    # In Docker container:
    docker exec storyheal-api resetadmin
...
Example:
    DATABASE_URL="postgresql://user:pass@localhost:5432/storyheal_api" python scripts/reset_admin_password.py
"""
...
def get_sync_database_url() -> str:
    ...
    if not database_url:
        ...
        print("Example: DATABASE_URL='postgresql://user:pass@localhost:5432/storyheal_api' python scripts/reset_admin_password.py")
        sys.exit(1)
