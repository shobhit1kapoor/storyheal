...
class WeComChannelListener:
    ...
    async def _register_visitor(
        ...
        """Register or get visitor through storyheal-api, using cache in VisitorService."""
    ...
    async def _get_or_register_visitor(
        ...
        3) Register or get visitor via storyheal-api using nickname/avatar; return result
        """
        display_name: str | None = None
        avatar_url: str | None = None
        visitor = None
