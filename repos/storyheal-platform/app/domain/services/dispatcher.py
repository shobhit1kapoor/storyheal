...
from app.domain.ports import StoryHealApiClient, SSEManager, PlatformAdapter
...
async def process_message(
    ...
    """End-to-end orchestration using DB platform config + storyheal-api SSE + adapter output.
    ...
    for attempt in range(3):
        try:
            ...
            # Choose platform-specific expected output format for storyheal-api
            ...
            frames = storyheal_api_client.chat_completion(req)
