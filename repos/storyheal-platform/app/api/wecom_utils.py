...
async def resolve_visitor_platform_open_id(visitor_id: str) -> str:
    """Resolve a storyheal-platform visitor_id to the platform-specific open ID with Redis caching.

    Cache key: visitor:{visitor_id}:platform_open_id
    Fetches from storyheal-api GET /v1/visitors/{visitor_id}/basic on cache miss.
    """
