...
from app.infra.http import HttpxStoryHealApiClient
...
async def lifespan(app: FastAPI):
    ...
    app.state.storyheal_api_client = HttpxStoryHealApiClient(settings.api_base_url, timeout=settings.request_timeout_seconds)
    ...
    app.state.email_listener = EmailChannelListener(
        ...
        storyheal_api_client=app.state.storyheal_api_client,
    ...
    try:
        ...
        await app.state.storyheal_api_client.aclose()
