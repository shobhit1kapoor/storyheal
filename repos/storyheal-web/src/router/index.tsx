...
import KnowledgeOpsDashboard from '../pages/KnowledgeOpsDashboard';
import ProposalReview from '../pages/ProposalReview';
import StoryblokSettings from '../pages/StoryblokSettings';
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { path: 'storyblok', element: <StoryblokSettings /> },
      ...
      {
        path: 'knowledge-ops',
        element: <KnowledgeOpsDashboard />
      },
      {
        path: 'knowledge-ops/proposals/:id',
