...
import { LuMessageCircle, LuSparkles, LuLibrary, LuSettings, LuUsers, LuShieldCheck } from 'react-icons/lu';
...
const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="w-16 flex flex-col items-center bg-white/70 dark:bg-gray-900/70 backdrop-blur-lg border-r border-gray-200/50 dark:border-gray-700/50 py-4 space-y-4 shrink-0 relative z-20">
      <div className="mb-2 flex h-9 w-9 select-none items-center justify-center rounded-xl bg-teal-700 text-white shadow-sm" title="StoryHeal">
