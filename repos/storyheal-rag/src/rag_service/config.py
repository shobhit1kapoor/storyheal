...
class Settings(BaseSettings):
    ...
    app_name: str = Field(default="StoryHeal RAG Service", description="Application name")
    ...
    embedding_model: str = Field(
        default="qwen3-embedding:0.6b", description="Embedding model name"
    )
    ...
    rag_internal_api_key: str = Field(
        default="change-me-in-production", description="Shared key for API-to-RAG ingestion"
    )
