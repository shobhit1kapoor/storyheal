"""
Main FastAPI application for StoryHeal RAG Service.
"""
...
from .routers import collections, files, health, monitoring, embedding_config, websites, qa, external_sources
...
async def lifespan(app: FastAPI):
    ...
    log_startup_step("Starting StoryHeal RAG Service initialization", version=settings.app_version, environment=settings.environment)
    ...
    try:
        ...
        log_startup_step("Shutting down StoryHeal RAG Service")
...
def create_app() -> FastAPI:
    ...
    app = FastAPI(
        ...
        description="StoryHeal RAG (Retrieval-Augmented Generation) Service for document processing and semantic search",
        docs_url="/docs",
        redoc_url="/redoc",
...
def setup_routers(app: FastAPI) -> None:
    ...
    app.include_router(
        ...
        prefix=f"{api_v1_prefix}/collections",
        tags=["Storyblok External Sources"],
    )
