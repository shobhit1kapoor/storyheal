...
const defaultConfig: PlatformState['config'] = {
  ...
  theme_color: '#2f80ed',
  widget_title: 'StoryHeal',
  welcome_message: undefined,
  logo_url: undefined,
}

const WELCOME_KEY = (apiBase: string, platformApiKey: string) => `storyheal:welcome-shown:${apiBase}:${platformApiKey}`
const EXPANDED_KEY = (apiBase: string, platformApiKey: string) => `storyheal:expanded:${apiBase}:${platformApiKey}`
