# StoryHeal Widget App (Vite + React + Emotion)
...
- Emotion 样式注入：可在 DevTools 中看到 `<style data-emotion="storyheal">` 与 `<style data-emotion="storyheal-global">`
...
./storyheal-widget
  ...
  └─ src/
     ...
     ├─ App.tsx
     ├─ styles/
     │  └─ emotionCache.ts   # key = "storyheal" → <style data-emotion="storyheal">
     └─ components/
        ├─ Header.tsx
        ├─ MessageList.tsx
        └─ MessageInput.tsx
