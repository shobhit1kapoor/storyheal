"""API Service client for interacting with the core StoryHeal API service."""
...
class APIServiceClient:
    """Client for interacting with the core StoryHeal API service."""
    ...
    async def execute_plugin_tool(
        ...
        """
        Execute a plugin tool via the StoryHeal Plugin Runtime service.
        ...
        async with httpx.AsyncClient(timeout=self.timeout) as client:
            try:
                ...
                return {
                    "success": False,
                    "error": str(e),
                    "content": "无法连接到 StoryHeal API 服务"
                }
