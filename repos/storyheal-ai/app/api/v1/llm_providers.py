"""LLM Provider sync API for storyheal-api -> storyheal-ai."""
...
@router.post(
    ...
    description="Upsert LLM Providers. Each item must include id and project_id; if a provider (project_id, alias) exists it will be updated, otherwise created. The id is provided by storyheal-api.",
