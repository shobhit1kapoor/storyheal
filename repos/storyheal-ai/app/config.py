...
class Settings(BaseSettings):
    ...
    database_url: str = Field(
        default="sqlite+aiosqlite:///./storyheal_ai_service.db",
    ...
    internal_service_api_key: str = Field(
        ...
        description="Shared secret accepted only by internal StoryHeal service endpoints",
    )
    ...
    ollama_base_url: str = Field(
        ...
        description="Local Ollama base URL used when no per-project provider is configured",
    )
    ollama_model: str = Field(default="qwen3:8b")
    allow_local_provider_fallback: bool = Field(default=True)
    ...
    device_control_mcp_endpoint: str = Field(
        default="http://storyheal-device-control:8085/mcp/{device_id}",
    ...
    test_database_url: str = Field(
        default="postgresql+asyncpg://postgres:password@localhost:5432/storyheal_ai_service_test",
