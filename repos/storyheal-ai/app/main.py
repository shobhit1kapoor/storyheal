...
app = FastAPI(
    title="StoryHeal AI Service",
    description="AI/ML Operations Microservice for StoryHeal customer service platform",
    version=__version__,
...
@app.exception_handler(StoryHealAIServiceException)
async def storyheal_ai_service_exception_handler(
    request: Request, exc: StoryHealAIServiceException
) -> JSONResponse:
    """Handle custom StoryHeal AI Service exceptions."""
