...
class ChatCompletionRequest(BaseModel):
    ...
    # StoryHeal-AI specific: provider credentials lookup
    ...
    reasoning_effort: Optional[Literal["none", "low", "medium", "high"]] = Field(
        default=None,
        description="Reasoning effort for compatible thinking models",
    )
    ...
    # StoryHeal-AI Extension: Dynamic Tool Loading
    ...
    auto_execute_tools: bool = Field(
        default=True,
        description="Whether storyheal-ai should auto-execute tool calls in an agentic loop. "
        "When True (default), storyheal-ai executes tool calls internally and continues the conversation. "
